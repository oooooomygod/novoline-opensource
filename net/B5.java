...
public class B5 {
    ...
    public static void b(int n, int n2, char c) {
        ...
        a = B5.a(-397939470, -397934714, (int)l4);
        e = B5.a(-397939469, -397942639, (int)l4);
        d = B5.a(-397939465, 397950375, (int)l4);
        b = B5.a(-397939471, 397928520 + (char)-30454, (int)l4);
        B5.c = B5.a(-397939472, 397950271, (int)l4);
    }
     ...
     */
    static {
        B5.f = a1c.a(7233527633781234691L, -5364046513148583524L, null).a(101172816720261L);
        var8 = B5.f ^ 75780801574317L;
        v0 = var8 ^ 130103157353555L;
        var10_1 = (int)(v0 >>> 32);
        var11_2 = (int)(v0 << 32 >>> 48);
        var12_3 = (int)(v0 << 48 >>> 48);
        var5_4 = new String[5];
        var3_5 = 0;
        var2_6 = "\u0096\u00f4\u001c\u008b\u0000'Q\u00df0\u00e3\u0004\u00f3!3?\u0006P\u00f4\u00ef)<\u00ba";
        var4_7 = "\u0096\u00f4\u001c\u008b\u0000'Q\u00df0\u00e3\u0004\u00f3!3?\u0006P\u00f4\u00ef)<\u00ba".length();
        var1_8 = 10;
        var0_9 = -1;
        block0: while (true) {
            block7: {
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            B5.g = var5_4;
            B5.h = new String[5];
            B5.b(var10_1, var11_2, (char)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (h[n4] == null) {
            ...
            B5.h[n4] = new String(cArray).intern();
        }
        return h[n4];
    }
}
