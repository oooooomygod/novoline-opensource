...
public class CV {
    ...
    private static long f = a1c.a(3075832428390608313L, 1247062037362460476L, null).a(239743700203639L);
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (h[n4] == null) {
            ...
            CV.h[n4] = new String(cArray).intern();
        }
        return h[n4];
    }
     ...
     */
    static {
        var8 = CV.f ^ 34395541141809L;
        v0 = var8 ^ 132217253615380L;
        var10_1 = (int)(v0 >>> 48);
        var11_2 = (int)(v0 << 16 >>> 32);
        var12_3 = (int)(v0 << 48 >>> 48);
        var5_4 = new String[5];
        var3_5 = 0;
        var2_6 = "\u0010H1\u00ed\u0097\u0006\u00fb\tx\u00eaW\u00ed\u0007\u000fF\u00e4\u0002\u0082\u00d0\u00ce";
        var4_7 = "\u0010H1\u00ed\u0097\u0006\u00fb\tx\u00eaW\u00ed\u0007\u000fF\u00e4\u0002\u0082\u00d0\u00ce".length();
        var1_8 = 5;
        var0_9 = -1;
        block0: while (true) {
            block7: {
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            CV.g = var5_4;
            CV.h = new String[5];
            CV.b((char)var10_1, var11_2, (char)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    public static void b(char c, int n, char c2) {
        ...
        a = CV.a(1819125964, -1819145063, (int)l4);
        e = CV.a(1819125966, -1819144293, (int)l4);
        d = CV.a(1819125965, -1819120374, (int)l4);
        CV.c = CV.a(1819125960, 1819117086, (int)l4);
        b = CV.a(1819125967, -1819139971, (int)l4);
    }
}
