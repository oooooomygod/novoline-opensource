...
public class aE2 {
     ...
     */
    static {
        aE2.p = a1c.a(4586892459419186482L, 7502999566888608595L, null).a(37953352744046L);
        var8 = aE2.p ^ 104754417193022L;
        v0 = var8 ^ 47334706982944L;
        var10_1 = (int)(v0 >>> 48);
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            aE2.q = var5_4;
            aE2.r = new String[4];
            aE2.b((char)var10_1, var11_2, (short)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (r[n4] == null) {
            ...
            aE2.r[n4] = new String(cArray).intern();
        }
        return r[n4];
    }

    public static void b(char c, int n, short s) {
        long l4 = ((long)c << 48 | (long)n << 32 >>> 16 | (long)s << 48 >>> 48) ^ p;
        d = "G";
        g = aE2.a(239717172, -239700899, (int)l4);
        b = aE2.a(239717174, 239723892, (int)l4);
        l = "F";
        k = aE2.a(239717174, 239723892, (int)l4);
        m = "A";
        e = "B";
        h = aE2.a(239717173, -239719866, (int)l4);
        o = aE2.a(239717174, 239723892, (int)l4);
        aE2.c = aE2.a(239717174, 239723892, (int)l4);
        i = aE2.a(239717174, 239723892, (int)l4);
        aE2.n = "D";
        f = "C";
        j = aE2.a(239717175, 239715037, (int)l4);
        a = aE2.a(239717174, 239723892, (int)l4);
    }
}
