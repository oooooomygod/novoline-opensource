...
public class aQR {
    ...
    private static long c = a1c.a(4668742002231719952L, -1140586955717239718L, null).a(2406018032091L);
     ...
     */
    static {
        long l4 = c ^ 0x74621DFEF607L;
        long l5 = l4 ^ 0x508079127F0L;
        int n = (int)(l5 >>> 32);
        int n2 = (int)(l5 << 32 >>> 48);
        int n3 = (int)(l5 << 48 >>> 48);
        String[] stringArray = new String[2];
        int n4 = 0;
        String string = "\u00b5\u00f2@\u00ebP\u00d6\u0006\u00de\u00c4--\u00fd\u000e";
        int n5 = "\u00b5\u00f2@\u00ebP\u00d6\u0006\u00de\u00c4--\u00fd\u000e".length();
        int n6 = 6;
        int n7 = -1;
        while (true) {
            char[] cArray;
    ...
    public static void b(int n, short s, int n2) {
        ...
        b = aQR.a(443533244, -443532571, (int)l4);
        a = aQR.a(443533245, 443521457, (int)l4);
    }

    private static String a(int n, int n2, int n3) {
        int n4 = (n ^ n3 ^ 0x164B) & 0xFFFF;
        if (e[n4] == null) {
            int n5;
            ...
            aQR.e[n4] = new String(cArray).intern();
        }
        return e[n4];
    }
}
