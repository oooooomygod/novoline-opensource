...
public class aR1 {
     ...
     */
    static {
        e = a1c.a(-576225358443241241L, -5995530179286194035L, null).a(202343760144885L);
        long l4 = e ^ 0x4A55C590660EL;
        long l5 = l4 ^ 0x3E81C26BDF0DL;
        int n = (int)(l5 >>> 32);
        int n2 = (int)(l5 << 32 >>> 40);
        int n3 = (int)(l5 << 56 >>> 56);
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (g[n4] == null) {
            ...
            aR1.g[n4] = new String(cArray).intern();
        }
        return g[n4];
    }
    ...
    public static void b(int n, int n2, byte by) {
        ...
        c = aR1.a(-133926070, 133930437, (int)l4);
        a = "(";
        b = ")";
        d = aR1.a(-133926069, -133925967, (int)l4);
    }
}
