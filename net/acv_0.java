...
public class acv_0 {
     ...
     */
    static {
        c = a1c.a(4640674333899102868L, 5550528283236722666L, null).a(171517863454693L);
        long l4 = c ^ 0x71FF4FB2308AL;
        long l5 = l4 ^ 0x2922626E4E49L;
        int n = (int)(l5 >>> 48);
        int n2 = (int)(l5 << 16 >>> 48);
        int n3 = (int)(l5 << 32 >>> 32);
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (e[n4] == null) {
            ...
            acv_0.e[n4] = new String(cArray).intern();
        }
        return e[n4];
    }

    public static void b(short s, char c, int n) {
        long l4 = ((long)s << 48 | (long)c << 48 >>> 16 | (long)n << 32 >>> 32) ^ acv_0.c;
        b = acv_0.a(769407063, 769380900 + (char)-26717, (int)l4);
        a = acv_0.a(769407062, 769407055, (int)l4);
    }
}
