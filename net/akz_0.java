 ...
 */
public class akz_0 {
    private static long e = a1c.a(2387173209861713886L, 155580897961157309L, null).a(4841412251339L);
     ...
     */
    static {
        var8 = akz_0.e ^ 14897006471811L;
        v0 = var8 ^ 135789689222340L;
        var10_1 = (int)(v0 >>> 56);
        var11_2 = (int)(v0 << 8 >>> 32);
        ...
        block0: while (true) {
            block7: {
                ...
                break block7;
                while (true) {
                    var2_6 = "\u00d7\u0096\u00de\u0017J\f\u007f8\t\u00943\u0096\u00a7G\u001e\u00da~\u00d3";
                    var4_7 = "\u00d7\u0096\u00de\u0017J\f\u007f8\t\u00943\u0096\u00a7G\u001e\u00da~\u00d3".length();
                    var1_8 = 8;
                    var0_9 = -1;
lbl33:
                    // 2 sources
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            akz_0.f = var5_4;
            akz_0.g = new String[4];
            akz_0.b((byte)var10_1, var11_2, var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    public static void b(byte by, int n, int n2) {
        ...
        d = akz_0.a(2063058442, 2063071801, (int)l4);
        c = akz_0.a(2063058441, -2063043469, (int)l4);
        a = akz_0.a(2063058440, 2063056491, (int)l4);
        b = akz_0.a(2063058443, -2063043279, (int)l4);
    }

    private static String a(int n, int n2, int n3) {
        int n4 = (n ^ n3 ^ 0x184D) & 0xFFFF;
        if (g[n4] == null) {
            int n5;
            ...
            akz_0.g[n4] = new String(cArray).intern();
        }
        return g[n4];
    }
}
