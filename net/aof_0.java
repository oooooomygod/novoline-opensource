...
public class aof_0 {
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (g[n4] == null) {
            ...
            aof_0.g[n4] = new String(cArray).intern();
        }
        return g[n4];
    }
     ...
     */
    static {
        aof_0.e = a1c.a(2278859900447509732L, -6300960705396681650L, null).a(97499695166025L);
        var8 = aof_0.e ^ 27358308207968L;
        v0 = var8 ^ 43006100875366L;
        var10_1 = (int)(v0 >>> 48);
        var11_2 = (int)(v0 << 16 >>> 32);
        var12_3 = (int)(v0 << 48 >>> 48);
        var5_4 = new String[4];
        var3_5 = 0;
        var2_6 = "\u008bA\u00a5\u00e3q\r\u0006o\u00f9=\u00f0fk";
        var4_7 = "\u008bA\u00a5\u00e3q\r\u0006o\u00f9=\u00f0fk".length();
        var1_8 = 6;
        var0_9 = -1;
        block0: while (true) {
            block7: {
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            aof_0.f = var5_4;
            aof_0.g = new String[4];
            aof_0.b((short)var10_1, var11_2, (char)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    public static void b(short s, int n, char c) {
        ...
        b = aof_0.a(110900422, 110888000, (int)l4);
        d = aof_0.a(110900421, -110911842, (int)l4);
        a = aof_0.a(110900420, 110902583, (int)l4);
        aof_0.c = aof_0.a(110900423, 110890542, (int)l4);
    }
}
