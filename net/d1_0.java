...
public class d1_0 {
    ...
    public static void b(short s, int n, char c) {
        ...
        d1_0.c = d1_0.a(832818997, 832806307, (int)l4);
        b = d1_0.a(832818996, -832816067, (int)l4);
        a = d1_0.a(832818999, -832803920, (int)l4);
        d = d1_0.a(832818998, 832814071, (int)l4);
    }
     ...
     */
    static {
        d1_0.e = a1c.a(-7024912534506517158L, 1001241820721545233L, null).a(42761669788299L);
        var8 = d1_0.e ^ 62012402073484L;
        v0 = var8 ^ 81946590715731L;
        var10_1 = (int)(v0 >>> 48);
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            d1_0.f = var5_4;
            d1_0.g = new String[4];
            d1_0.b((short)var10_1, var11_2, (char)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (g[n4] == null) {
            ...
            d1_0.g[n4] = new String(cArray).intern();
        }
        return g[n4];
    }
}
