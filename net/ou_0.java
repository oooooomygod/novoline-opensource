...
public class ou_0 {
    ...
    private static long b = a1c.a(8227657107062360164L, -3754768038223222192L, null).a(22249114094477L);
     ...
     */
    static {
        long l4 = b ^ 0x23EB886FBF40L;
        long l5 = l4 ^ 0x59315C0F8057L;
        int cfr_ignored_0 = (int)(l5 >>> 48);
        int cfr_ignored_1 = (int)(l5 << 16 >>> 48);
        int cfr_ignored_2 = (int)(l5 << 32 >>> 32);
        char[] cArray = "eI\"\u0002orf".toCharArray();
        int n = 0;
        int n2 = 94;
        char[] cArray2 = cArray;
