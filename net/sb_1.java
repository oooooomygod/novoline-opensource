...
public class sb_1 {
    ...
    private static String a(int n, int n2, int n3) {
        ...
        if (e[n4] == null) {
            ...
            sb_1.e[n4] = new String(cArray).intern();
        }
        return e[n4];
    }
     ...
     */
    static {
        c = a1c.a(497377722315729490L, -4266535207823926607L, null).a(47343619426478L);
        long l4 = c ^ 0x731E97106C6BL;
        long l5 = l4 ^ 0x3BF261EC29B4L;
        int n = (int)(l5 >>> 32);
        int n2 = (int)(l5 << 32 >>> 48);
        int n3 = (int)(l5 << 48 >>> 48);
        String[] stringArray = new String[2];
        int n4 = 0;
        String string = "E\u009f\u00b8#\u0097e\u0006a\u00cc<I\u0007(";
        int n5 = "E\u009f\u00b8#\u0097e\u0006a\u00cc<I\u0007(".length();
        int n6 = 6;
        int n7 = -1;
        while (true) {
            char[] cArray;
    ...
    public static void b(int n, char c, char c2) {
        long l4 = ((long)n << 32 | (long)c << 48 >>> 32 | (long)c2 << 48 >>> 48) ^ sb_1.c;
        b = sb_1.a(151239092, 151243315, (int)l4);
        a = sb_1.a(151239093, -151244044, (int)l4);
    }
}
