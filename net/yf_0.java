...
public class yf_0 {
    ...
    public static String b = "ForcedAge";
    public static String d = "ForcedAge";
     ...
     */
    static {
        yf_0.e = a1c.a(1993324215992578187L, 4561090178664186275L, null).a(97595797473778L);
        var8 = yf_0.e ^ 109393708661957L;
        v0 = var8 ^ 7631133774714L;
        var10_1 = (int)(v0 >>> 32);
        ...
        block0: while (true) {
            block7: {
                ...
                break block7;
                while (true) {
                    var2_6 = "\u0006m8\u00b9\u00fd\u00d5g\u00cd\u00eb\tP\u00c9\u00f2-\u00a4GL\u009f\u008e";
                    var4_7 = "\u0006m8\u00b9\u00fd\u00d5g\u00cd\u00eb\tP\u00c9\u00f2-\u00a4GL\u009f\u008e".length();
                    var1_8 = 9;
                    var0_9 = -1;
lbl33:
                    // 2 sources
...
lbl79:
        ...
        if ((var0_9 += var1_8) >= var4_7) {
            yf_0.f = var5_4;
            yf_0.g = new String[4];
            yf_0.b(var10_1, var11_2, (byte)var12_3);
            return;
        }
        var1_8 = var2_6.charAt(var0_9);
        ** while (true)
    ...
    public static void b(int n, int n2, byte by) {
        ...
        b = yf_0.a(165551145, -165564710, (int)l4);
        a = yf_0.a(165551146, 165560866, (int)l4);
        c = yf_0.a(165551147, 165554488, (int)l4);
        d = yf_0.a(165551144, -165547496, (int)l4);
    }

    private static String a(int n, int n2, int n3) {
        int n4 = (n ^ n3 ^ 0xFFFFB395) & 0xFFFF;
        if (g[n4] == null) {
            int n5;
            ...
            yf_0.g[n4] = new String(cArray).intern();
        }
        return g[n4];
    }
}
