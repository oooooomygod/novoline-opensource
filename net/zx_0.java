...
extends YJ {
    ...
    public void a(Y_ y_, List<Y_> list, Random random) {
        ...
        this.a((zr_0)y_, list, random, 5, 11, true);
    }

    public static zx_0 a(List<Y_> list, Random random, int n, int n2, int n3, EnumFacing enumFacing, int n4) {
        HF hF = aqu_2.a(n, n2, n3, -5, -3, 0, 13, 14, 13, enumFacing);
        return zx_0.a(hF) && Y_.a(list, hF) == null ? new zx_0(n4, random, hF, enumFacing) : null;
    }

    public zx_0() {
    }

    public zx_0(int n, Random random, HF hF, EnumFacing enumFacing) {
        super(n);
        this.c = enumFacing;
        this.b = hF;
    }
